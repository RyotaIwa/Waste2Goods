import { 
  WeeklyData, MonthlyData, WasteType, LeaderboardUser, Reward, Task, Transaction, User, Kiosk, PointRate, AuthUser,
...
export const DEMO_KIOSK_USER: AuthUser = {
  id: "K-01",
...
export const RECYCLABLE_MATERIALS: RecyclableMaterial[] = [
...
export const RECYCLING_TASKS: RecyclingTask[] = [
  {
    taskId: 1,
...
export const USER_RECYCLING_TASKS: UserRecyclingTask[] = [
  { userTaskId: 1, userId: "U-001", taskId: 1, progress: 70, completedAt: undefined }
];

export const RECYCLING_TRANSACTIONS: RecyclingTransaction[] = [
  {
...
export const POINT_RATES: PointRate[] = [
